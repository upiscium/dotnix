...
This workflow is read-only unless the user separately requests fixes. Discover the installed OpenCode version and schema before evaluating configuration.
