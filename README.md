...
The recommended path is the manual **GitHub Actions → Update OpenCodePolicy → Run workflow** operation, or:

```sh
gh workflow run update-opencode-policy.yml --repo upiscium/dotnix
```
